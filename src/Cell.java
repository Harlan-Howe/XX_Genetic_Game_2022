...
public class Cell
{
	...
	private static String[] filenames = {"CharcoalChip.png","BlueChip.png","GreenChip.png","PurpleChip.png","RedChip.png","YellowChip.png"};
	private static String[] cellColors = {"Charcoal","Blue","Green","Purple","Red","Yellow"};
...
// ===================================  OVERRIDDEN OBJECT METHODS ==============================
	...
	{
		return "Cell: "+marker+": color:"+cellColors[colorID]+"\t("+this.x+", "+this.y+")";
	}
	...
	public Object clone()
	{
		return new Cell(this.colorID,this.y/CELL_SIZE,this.x/CELL_SIZE,this.marker,this.displayMarker);
	}
